...
INSERT INTO replay_user (id, class, name, pl_comment, gm_comment, color_hex, memo, is_deleted) VALUES
    ...
    (6, 'sukamomo', 'sukamomo', 'コメントください', '本セッションのGMを担当', 'FF4081', '', FALSE),
    (7, 'xino', 'xino', 'ベテランCoCプレイヤー。柔軟なRPと堅実な技能構成でサポートと探索をそつなくこなす', '本セッションのGMを担当', 'FF4081', '', FALSE),
    (8, 'yuto', 'yuto', 'コメントください', '本セッションのGMを担当', 'FF4081', '', FALSE),
    (9, 'bcf', 'bcf', 'リアルでは迷宮ハンターを生業にしているらしい', '本セッションのGMを担当', 'FF4081', '', FALSE)
;